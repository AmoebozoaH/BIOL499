...
#SBATCH --output=/home/z392huan/scratch/Part2/nanopore_racon/log/kraken_nano_homo_%A_%a.out
#SBATCH --error=/home/z392huan/scratch/Part2/nanopore_racon/log/kraken_nano_homo_%A_%a.err
...
mkdir -p /home/z392huan/scratch/Part2/nanopore_racon/racon1/kraken_contig_result/
DIR="/home/z392huan/scratch/Part2/nanopore_racon/racon1/kraken_contig_result/"

SAMP=$(sed -n "${SLURM_ARRAY_TASK_ID}p" /home/z392huan/scratch/Part2/nanopore_racon/racon1/nanopore_racon1.txt)
...
kraken2 --db /home/z392huan/projects/def-acdoxey/k2_pluspf_20250714 \
	...
	/home/z392huan/scratch/Part2/nanopore_racon/racon1/${SAMP}.fasta
