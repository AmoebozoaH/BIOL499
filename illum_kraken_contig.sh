...
#SBATCH --output=/home/z392huan/script/log/kraken_illumi_contig_%A_%a.out
#SBATCH --error=/home/z392huan/script/log/kraken_illumi_contig_%A_%a.err
...
# requirement: preconstruct sample.txt file using ls *.fasta | sed 's/\.fasta$//' > illumi_sample.txt


#mkdir -p /home/z392huan/scratch/kraken_contig_result/
mkdir -p /home/z392huan/scratch/Part2/illumina/kraken_contig_result/
DIR="/home/z392huan/scratch/Part2/illumina/kraken_contig_result/"

SAMP=$(sed -n "${SLURM_ARRAY_TASK_ID}p" /home/z392huan/scratch/Part2/illumi_sample.txt)
...
kraken2 --db /home/z392huan/projects/def-acdoxey/k2_pluspf_20250714 \
	...
	/home/z392huan/scratch/Part2/illumina/${SAMP}.fasta
