...
#SBATCH --output=/home/z392huan/scratch/Part2/nanopore_medaka/log/kraken_nano_racon_medaka_%A_%a.out
#SBATCH --error=/home/z392huan/scratch/Part2/nanopore_medaka/log/kraken_nano_racon_medaka_%A_%a.err
...
mkdir -p /home/z392huan/scratch/Part2/nanopore_racon_medaka3/kraken_contig_result/
DIR="/home/z392huan/scratch/Part2/nanopore_racon_medaka3/kraken_contig_result/"

SAMP=$(sed -n "${SLURM_ARRAY_TASK_ID}p" /home/z392huan/scratch/Part2/nanopore_racon_medaka3/nanopore_racon_medaka_sample.txt)
...
kraken2 --db /home/z392huan/projects/def-acdoxey/k2_pluspf_20250714 \
	...
	/home/z392huan/scratch/Part2/nanopore_racon_medaka3/${SAMP}_nanopore.racon_iter3.racon.medaka.fasta
