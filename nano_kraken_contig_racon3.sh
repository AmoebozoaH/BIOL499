...
#SBATCH --output=/home/z392huan/scratch/Part2/nanopore_racon/log/kraken_nano_racon3_%A_%a.out
#SBATCH --error=/home/z392huan/scratch/Part2/nanopore_racon/log/kraken_nano_racon3_%A_%a.err
...
mkdir -p /home/z392huan/scratch/Part2/nanopore_racon/polisher_racon_iteration3_new/kraken_contig_result/
DIR="/home/z392huan/scratch/Part2/nanopore_racon/polisher_racon_iteration3_new/kraken_contig_result/"
...
kraken2 --db /home/z392huan/projects/def-acdoxey/k2_pluspf_20250714 \
	...
	/home/z392huan/scratch/Part2/nanopore_racon/polisher_racon_iteration3_new/${SAMP}.fasta
